...
def yardim_bas():
    ...
    print("  analiz        : Sistem Raporunu Göster         | disk          : Disk Kullanımı")
    
    print("\033[1;32m[DOSYA VE ARAÇLAR]")
    print("  yarat [isim]  : Yeni Klasör Oluştur            | sil [isim]    : Dosya/Klasör Sil")
    print("  ara [isim]    : Dosya Ara                      | boyut [isim]  : Dosya Boyutu")
    print("  oku [dosya]   : İçeriği Görüntüle              | gezgin        : Dosyaları Listele")
    
    print("\033[1;33m[YENİ: ARAÇ KUTUSU]")
    print("  hava [sehir]  : Hava Durumunu Göster           | hesapla [işlem]: Matematik Çözer")
    print("  indir [url] [ad]: İnternetten Dosya İndir      | parola-uret   : Güvenli Şifre")
    print("  web [url]     : Tarayıcıda Site Aç             | ip_bul        : IP Adresini Gör")
    
    print("\033[1;31m[GÜÇ VE ÇIKIŞ]")
    print("  kapat / yeniden / kilitle                      | temizle       : Ekranı Tazele")
    print("  çıkış         : STerm'i Kapat                  | yardım        : Bu Menü")
