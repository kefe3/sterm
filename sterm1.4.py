...
def show_banner():
    ...
    print("\033[1;36m" + "█"*65)
    print(f"  ⚡ STerm v1.4 UNIVERSAL - KAPSÜL SERIX ECOSYSTEM ⚡")
    print(f"  PLATFORM: {system_name} | HOST: {socket.gethostname()} | DEV: kefe3")
    print("  " + "█"*65 + "\033[0m")
...
def print_help():
    ...
    print("  help          : Bu Rehberi Tekrar Açar")
    print("  exit          : STerm'den Çıkış Yap")
